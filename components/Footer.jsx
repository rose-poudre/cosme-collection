      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-y-10 px-10 py-14 bg-gray-200">
        <div className="space-y-4 text-xs text-gray-800">
          <h5
            ...
            className="cursor-pointer hover:text-white font-bold hover:shadow-lg  hover:bg-gray-400 transform transition duration-300 ease-out"
          >
            スキンケア
          </h5>
          <p
            className="cursor-pointer hover:text-white hover:shadow-lg hover:bg-gray-400 transform transition duration-300 ease-out"

      ...
      <div>
        ...
        <div className="mx-auto ">
          <div className="flex mt-10">
            ...
            <button
              onClick={search}
              className="flex-grow text-white bg-gold-500 w-20 py-2 mx-2 md:mx-10 rounded-sm cursor-pointer hover:scale-105 transform transition duration-300 ease-out"
            >
              Search
            </button>
